                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link" data-toggle="pill" href="#contact_address">Contact Address</a></li>
                        </ul>
                        <div class="tab-content pt-1">
                            <div id="personal" class="tab-pane active">
                                <div class="card no-shadow mb-0">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12 col-md-3"><img src="dist/img/avatar.png" alt="User-profile" width="100%" class="img-size-60 img-thumbnail"></div>
